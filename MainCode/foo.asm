  ...
  19:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  28:	0f 84 82 00 00 00    	je     b0 <main+0xb0>
      printf(1, "Parent %d creating child  %d\n", getpid(), id );
  2e:	e8 7f 03 00 00       	call   3b2 <getpid>
  33:	57                   	push   %edi
  34:	50                   	push   %eax
  for ( k = 0; k < n; k++ ) {
  35:	83 c6 01             	add    $0x1,%esi
      printf(1, "Parent %d creating child  %d\n", getpid(), id );
  38:	68 fc 07 00 00       	push   $0x7fc
  3d:	6a 01                	push   $0x1
  3f:	e8 4c 04 00 00       	call   490 <printf>
      wait ();
  44:	e8 f1 02 00 00       	call   33a <wait>
  49:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  4c:	39 de                	cmp    %ebx,%esi
  4e:	7d 30                	jge    80 <main+0x80>
    id = fork ();
  50:	e8 d5 02 00 00       	call   32a <fork>
    if ( id < 0 ) {
  55:	85 c0                	test   %eax,%eax
    id = fork ();
  57:	89 c7                	mov    %eax,%edi
    if ( id < 0 ) {
  59:	79 cd                	jns    28 <main+0x28>
      printf(1, "%d failed in fork!\n", getpid() );
  5b:	e8 52 03 00 00       	call   3b2 <getpid>
  60:	83 ec 04             	sub    $0x4,%esp
  for ( k = 0; k < n; k++ ) {
  63:	83 c6 01             	add    $0x1,%esi
      printf(1, "%d failed in fork!\n", getpid() );
  66:	50                   	push   %eax
  67:	68 e8 07 00 00       	push   $0x7e8
  6c:	6a 01                	push   $0x1
  6e:	e8 1d 04 00 00       	call   490 <printf>
  73:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  76:	39 de                	cmp    %ebx,%esi
  78:	7c d6                	jl     50 <main+0x50>
  ...
  8b:	ff 70 04             	pushl  0x4(%eax)
  8e:	e8 2d 02 00 00       	call   2c0 <atoi>
  if ( n < 0 || n > 20 )
  93:	83 c4 10             	add    $0x10,%esp
  96:	83 f8 14             	cmp    $0x14,%eax
    n = atoi ( argv[1] ); //from command line
  99:	89 c3                	mov    %eax,%ebx
  if ( n < 0 || n > 20 )
  9b:	76 2d                	jbe    ca <main+0xca>
    n = 2;
  9d:	bb 02 00 00 00       	mov    $0x2,%ebx
  a2:	e9 7a ff ff ff       	jmp    21 <main+0x21>
  a7:	89 f6                	mov    %esi,%esi
  a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      printf(1, "Child %d created\n",getpid() );
  b0:	e8 fd 02 00 00       	call   3b2 <getpid>
  b5:	83 ec 04             	sub    $0x4,%esp
  b8:	50                   	push   %eax
  b9:	68 1a 08 00 00       	push   $0x81a
  be:	6a 01                	push   $0x1
  c0:	e8 cb 03 00 00       	call   490 <printf>
  c5:	83 c4 10             	add    $0x10,%esp
  c8:	eb fe                	jmp    c8 <main+0xc8>
  for ( k = 0; k < n; k++ ) {
  ca:	85 c0                	test   %eax,%eax
  cc:	0f 85 4f ff ff ff    	jne    21 <main+0x21>
  d2:	eb ac                	jmp    80 <main+0x80>
  d4:	66 90                	xchg   %ax,%ax
  d6:	66 90                	xchg   %ax,%ax
  d8:	66 90                	xchg   %ax,%ax
  da:	66 90                	xchg   %ax,%ax
