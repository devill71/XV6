...
_change:     file format elf32-i386
  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  66:	50                   	push   %eax
  67:	56                   	push   %esi
  68:	e8 1d 03 00 00       	call   38a <chpr>
  ...
  79:	6a 02                	push   $0x2
  7b:	e8 c0 03 00 00       	call   440 <printf>
    exit();
 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 3d7:	f7 f1                	div    %ecx
 3d9:	0f b6 92 08 08 00 00 	movzbl 0x808(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb 00 08 00 00       	mov    $0x800,%ebx
        while(*s != 0){
 ...
 611:	a1 b4 0a 00 00       	mov    0xab4,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 b4 0a 00 00       	mov    %eax,0xab4
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 b4 0a 00 00       	mov    %eax,0xab4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 b4 0a 00 00    	mov    0xab4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 b4 0a 00 00    	cmp    %eax,0xab4
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 b4 0a 00 00    	mov    0xab4,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 b4 0a 00 00    	mov    %edx,0xab4
}
 ...
 767:	0a 00 00 
 76a:	c7 05 b8 0a 00 00 b8 	movl   $0xab8,0xab8
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 b8 0a 00 00       	mov    $0xab8,%eax
