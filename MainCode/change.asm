  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  4a:	83 fa 02             	cmp    $0x2,%edx
  4d:	76 13                	jbe    62 <main+0x62>
      printf(2, "Invalid priority (1-3)!\n" );
  4f:	51                   	push   %ecx
  50:	51                   	push   %ecx
  51:	68 94 07 00 00       	push   $0x794
  56:	6a 02                	push   $0x2
  ...
  64:	50                   	push   %eax
  65:	56                   	push   %esi
  66:	e8 ff 02 00 00       	call   36a <chpr>

  exit();
  6b:	e8 52 02 00 00       	call   2c2 <exit>
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb ad 07 00 00       	mov    $0x7ad,%ebx
        while(*s != 0){
