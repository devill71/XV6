...
int main(int argc,char *argv[3]){
  ...
  1a:	6a 00                	push   $0x0
  1c:	ff 73 04             	pushl  0x4(%ebx)
  1f:	e8 fe 02 00 00       	call   322 <open>
  ...
  30:	8d 9d e8 fd ff ff    	lea    -0x218(%ebp),%ebx
  36:	e8 e7 02 00 00       	call   322 <open>
	while((sz=read(fd, str,512))>0)
  3b:	83 c4 10             	add    $0x10,%esp
	int fd1 = open(argv[2],O_CREATE|O_RDWR);
  3e:	89 c7                	mov    %eax,%edi
	while((sz=read(fd, str,512))>0)
  40:	eb 14                	jmp    56 <main+0x56>
  ...
  4c:	53                   	push   %ebx
  4d:	57                   	push   %edi
  4e:	e8 af 02 00 00       	call   302 <write>
  ...
  5e:	53                   	push   %ebx
  5f:	56                   	push   %esi
  60:	e8 95 02 00 00       	call   2fa <read>
  65:	83 c4 10             	add    $0x10,%esp
  68:	85 c0                	test   %eax,%eax
  6a:	7f dc                	jg     48 <main+0x48>
	close(fd);
  6c:	83 ec 0c             	sub    $0xc,%esp
  6f:	56                   	push   %esi
  70:	e8 95 02 00 00       	call   30a <close>
	close(fd1);
  75:	89 3c 24             	mov    %edi,(%esp)
  78:	e8 8d 02 00 00       	call   30a <close>
	exit();
 ...
 611:	a1 50 0a 00 00       	mov    0xa50,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 50 0a 00 00       	mov    %eax,0xa50
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 50 0a 00 00 54 	movl   $0xa54,0xa50
 767:	0a 00 00 
 76a:	c7 05 54 0a 00 00 54 	movl   $0xa54,0xa54
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 54 0a 00 00       	mov    $0xa54,%eax
 779:	c7 05 58 0a 00 00 00 	movl   $0x0,0xa58
 780:	00 00 00 
